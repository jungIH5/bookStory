      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.125rem' }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ position: 'relative' }}>
              <input className="form-input" style={{ color: '#1C140E', paddingRight: '3rem' }} placeholder="동네, 역 이름 또는 장소명 (예: 합정역)" value={clubForm.location} onChange={(e) => handleLocationChange(e.target.value)} />
