      ...
      >
        ...
        <div style={{ background: 'linear-gradient(135deg, rgba(28,20,14,0.97), rgba(44,26,16,0.97))', padding: '1.75rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div style={{ minWidth: 0 }}>
            <p style={{ fontSize: '9px', fontWeight: 900, color: '#C49456', textTransform: 'uppercase', letterSpacing: '0.12em', marginBottom: '0.375rem' }}>세션이 자동 종료됐어요</p>
            ...
            {item.book_title && <p style={{ fontSize: '12px', color: '#7B6B55', fontWeight: 700, marginTop: '0.25rem', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{item.book_title}</p>}
          </div>
        </div>
        ...
        <div style={{ padding: '1.25rem 1.75rem', background: 'rgba(140,107,66,0.04)', borderBottom: '1px solid rgba(139,107,66,0.1)', display: 'flex', alignItems: 'center', gap: '0.625rem' }}>
          ...
          <span style={{ fontSize: '0.875rem', fontWeight: 700, color: '#7B6B55' }}>자동 계산된 예상 시간</span>
          <span style={{ fontSize: '1rem', fontWeight: 900, color: '#1C140E', marginLeft: 'auto' }}>{formatReadingTime(item.estimated_seconds)}</span>
        </div>

        <div style={{ padding: '1.75rem' }}>
          <p style={{ fontSize: '1rem', fontWeight: 900, color: '#1C140E', marginBottom: '0.5rem' }}>독서기록을 켜둔 채로 자리를 비우셨나 봐요</p>
          <p style={{ fontSize: '0.8125rem', color: '#9E8D7A', fontWeight: 700, marginBottom: '1.25rem', lineHeight: 1.5 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem', marginBottom: '1.5rem' }}>
            <input
              ...
              style={{
                ...
                border: '1px solid rgba(139,107,66,0.25)', background: 'white',
                fontSize: '1rem', fontWeight: 800, color: '#1C140E', textAlign: 'center',
              }}
            />
            <span style={{ fontSize: '0.875rem', fontWeight: 700, color: '#7B6B55' }}>분</span>
          </div>
